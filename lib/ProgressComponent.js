...
class ProgressComponent extends Component {
    ...
    async _updateProgress() {
        ...
        try {
            const data = {
                position: await TrackPlayer.getPosition(this.props.playerId),
                bufferedPosition: await TrackPlayer.getBufferedPosition(this.props.playerId),
                duration: await TrackPlayer.getDuration(this.props.playerId)
            };
