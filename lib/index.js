...
function add(playerId, tracks, insertBeforeId) {
    ...
    return TrackPlayer.add(playerId, tracks, insertBeforeId);
}

function remove(playerId, tracks) {
    if(!Array.isArray(tracks)) {
        tracks = [tracks];
    }

    return TrackPlayer.remove(playerId, tracks);
}
